...
public class DeliveryManagementTabController {
    ...
    private void loadDrivers() {
        ...
        String sql = "SELECT name FROM drivers WHERE status = 'Available' ORDER BY name";
        ...
        try (Connection conn = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                driverComboBox.getItems().add(driverName);
            }
            
            System.out.println("Loaded " + drivers.size() + " available drivers");
            
            // If no drivers, show message
            if (drivers.isEmpty()) {
    ...
    private void assignOrderToDriver(int orderId, String driverName) {
        ...
        try {
            ...
            try {
                ...
                // 2. Update driver status to 'On Delivery'
                ...
                // 3. Insert into delivery_logs (SIMPLIFIED - without driver_id for now)
                try {
                    ...
                    try (PreparedStatement ps = conn.prepareStatement(logSql)) {
                        ...
                        ps.executeUpdate();
                        System.out.println("DEBUG: Inserted into delivery_logs");
                    }
                } catch (SQLException e) {
                    System.out.println("DEBUG: Could not insert into delivery_logs: " + e.getMessage());
                ...
                showAlert("Success", 
                         ...
                         "The order will now appear only in " + driverName + "'s dashboard.",
