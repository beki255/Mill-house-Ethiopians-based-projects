...
public class InventoryManagementTabController {
    ...
    private void loadInventory() {
        ...
        // FIXED SQL: Direct join with settings table
        String sql = "SELECT i.grain_type, i.current_stock_kg, " +
                    "COALESCE(s.price_per_kg, 45.00) as price_per_kg " +
                    "FROM inventory i " +
    ...
    private void handleAddGrain() {
        ...
        try {
            ...
            String settingsSql = "INSERT INTO settings (grain_type, price_per_kg) VALUES (?, ?) " +
                                "ON DUPLICATE KEY UPDATE price_per_kg = ?";
