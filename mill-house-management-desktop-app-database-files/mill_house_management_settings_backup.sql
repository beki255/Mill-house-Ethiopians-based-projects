...
--
-- Table structure for table `settings_backup`
--
...
CREATE TABLE `settings_backup` (
  ...
  `delivery_fee_per_kg` decimal(10,2) DEFAULT '5.00',
  `grain_type` varchar(100) DEFAULT NULL,
  `price_per_kg` decimal(10,2) DEFAULT NULL,
  `low_stock_threshold` decimal(10,2) DEFAULT '200.00'
