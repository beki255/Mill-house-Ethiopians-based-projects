...
CREATE TABLE `password_requests` (
  ...
  CONSTRAINT `password_requests_ibfk_1` FOREIGN KEY (`customer_id`) REFERENCES `users` (`id`),
  CONSTRAINT `password_requests_ibfk_2` FOREIGN KEY (`handled_by`) REFERENCES `users` (`id`)
